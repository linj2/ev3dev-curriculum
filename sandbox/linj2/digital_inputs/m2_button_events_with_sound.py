...
def main():
    ...
    # TODONE: 3. Just below this comment add SIMPLE (no lambda) callbacks for:
    ...
    # TODONE: 5. Note #4 is lower (this is TO DO #5 which you should do after #4).
...
# TODONE: 4. Implement the up, down, left, and right callback functions as follows:
...
# TODONE: 6. Implement the handle_shutdown function.
