...
# TODONE: 3. Have someone on your team run this program on the EV3 and make sure everyone understands the code.
...
def main():
    ...
    # TODONE: 2. Have everyone talk about this problem together then pick one  member to modify libs/robot_controller.py
...
def left_motor_drive(button_state,robot):
    left_motor = ev3.LargeMotor(ev3.OUTPUT_B)
    assert left_motor.connected
    if button_state:
        ev3.Leds.set_color(ev3.Leds.LEFT, ev3.Leds.GREEN)
        left_motor.run_to_rel_pos(position_sp=600, speed_sp=900)
