...
def arm_calibration(arm_motor, touch_sensor):
    ...
    """
    # TODONE: 3. Implement the arm calibration movement by fixing the code below (it has many bugs).  It should to this:
...
def arm_up(arm_motor, touch_sensor):
    ...
    Type hints:
      ...
      :type touch_sensor: ev3.TouchSensor
    """
    # TODONE: 4. Implement the arm up movement by fixing the code below
    # Command the arm_motor to run forever in the positive direction at max speed.
...
def arm_down(arm_motor):
    ...
    arm_motor.run_to_abs_pos(postion_sp= 0, speed_sp = MAX_SPEED)
