...
# TODONE: 2. Have someone on your team run this program as is on the EV3 and make sure everyone understands the code.
...
def main():
    ...
    # TODONE: 5. Create remote control objects for channels 2, 3, and 4. Add lambda callbacks for on_red_up to each one:
    ...
    while dc.running:
        # TODONE: 4. Call the .process() method on your channel 1 RemoveControl object, then review and run your code.
        #   Review the handle functions below to see how they draw to the screen.  They are already finished.
        rc1.process()
        # TODONE: 6. Call the .process() method on your channel 2 - 4 RemoveControl objects and demo your code.
        #   Review the handle functions below to see how they draw to the screen.  They are already finished.
        rc2.process()
        rc3.process()
        rc4.process()
