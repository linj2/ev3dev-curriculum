...
def main():
    ...
    my_name = "Jing"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Nick and zijian"  # Used to set the topic that you will *publish to*
